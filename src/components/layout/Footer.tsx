        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/servizi" className="hover:text-gray-300">
                  Servizi
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/affiliazioni" className="hover:text-gray-300">
                  Diventa Affiliato
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p>Email: info@elabzone.it</p>
            <p>Tel: +39 123 456 7890</p>
            <p className="mt-2">www.elabzone.it</p>
          </div>
        </div>

        {/* Copyright */}
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p>© {new Date().getFullYear()} Elabzone. Tutti i diritti riservati.</p>
        </div>
      </div>
    </footer>
  );
